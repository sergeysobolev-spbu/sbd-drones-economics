...
from shared.monitor_client import monitor_proxy
...
def build_worker_service_deps(bus: SystemBus, self_topic: str, component_id: str) -> WorkerServiceDeps:
    ...
    def _proxy(target_topic: str, target_action: str, data: dict[str, Any]) -> dict[str, Any]:
        return monitor_proxy(bus, self_topic, target_topic, target_action, data)
