...
/** Интерфейс администратора: общий каркас. */
...
<template>
  ...
  >
    <template #nav>
      <NuxtLink to="/admin/users" data-testid="nav-admin-users">Пользователи</NuxtLink>
    </template>
    <template #title>
    ...
    <template #settings>
      <div class="stack">
        ...
        <p class="hint muted">
          По умолчанию используется тёмная тема (ТЗ).
        </p>
      </div>
    </template>
    <slot />
