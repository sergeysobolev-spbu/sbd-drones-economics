...
echo "Checking compose containers are running/healthy."
docker compose -f "${COMPOSE_FILE}" ps

require_container_running "operator-zookeeper"
require_container_running "operator-kafka"
...
wait_healthy "operator-kafka" 120
