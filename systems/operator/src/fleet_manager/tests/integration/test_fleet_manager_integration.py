...
class TestFleetManagerIntegration:
    ...
    def fleet_manager(self, mock_bus, mock_developer_client, mock_regulator_client):
        ...
        config = {
            "developer_client": mock_developer_client,
            "regulator_client": mock_regulator_client
        }
    ...
    async def test_get_uas_list(self, fleet_manager):
        ...
        fleet_manager.core.add_uas("UAS-001", {
    ...
    async def test_get_fleet_statistics(self, fleet_manager):
        ...
        for i in range(3):
            fleet_manager.core.add_uas(f"UAS-00{i+1}", {
                "certificate_valid": True,
                "certificate_expiry": "2027-01-01",
                "battery_level": 0.5 + i * 0.2
            })
