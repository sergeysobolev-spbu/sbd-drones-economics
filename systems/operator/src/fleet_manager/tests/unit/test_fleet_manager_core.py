...
from systems.operator.src.fleet_manager.src.fleet_manager_core import FleetManagerCore, UASStatus
...
class TestFleetManagerCore:
    ...
    def test_authorize_uas_operation_not_found(self, core):
        ...
        authorized, reason = core.authorize_uas_operation("UAS-999", "reserve", "operator_01")
    ...
    def test_authorize_uas_operation_invalid_certificate(self, core):
        ...
        core.add_uas("UAS-001", {"certificate_valid": False, "certificate_expiry": "2027-01-01", "battery_level": 1.0})

        authorized, reason = core.authorize_uas_operation("UAS-001", "reserve", "operator_01")
    ...
    def test_authorize_mission_operation_low_battery(self, core):
        ...
        core.add_uas("UAS-001", {"certificate_valid": True, "certificate_expiry": "2027-01-01", "battery_level": 0.2})
        core._fleet_state["UAS-001"].status = UASStatus.RESERVED

        authorized, reason = core.authorize_uas_operation("UAS-001", "mission", "operator_01")
    ...
    def test_update_uas_state_success(self, core, sample_uas_state):
        ...
        updates = {"status": "maintenance", "battery_level": 0.5, "certificate_valid": False}
