...
class TestMissionPlannerCore:
    ...
    def valid_waypoints(self):
        ...
        return [
            Waypoint(latitude=55.7558, longitude=37.6173, altitude=50.0, speed=10.0, action="takeoff"),
            Waypoint(latitude=55.7600, longitude=37.6200, altitude=50.0, speed=15.0, action="photo", duration=5.0),
            Waypoint(latitude=55.7650, longitude=37.6250, altitude=50.0, speed=15.0),
            Waypoint(latitude=55.7558, longitude=37.6173, altitude=0.0, speed=5.0, action="land"),
        ]
    ...
    def emergency_points(self):
        ...
        return [
            Waypoint(latitude=55.7580, longitude=37.6190, altitude=0.0, speed=0.0),
            Waypoint(latitude=55.7620, longitude=37.6220, altitude=0.0, speed=0.0),
        ]
    ...
    def test_validate_no_fly_zone_violation(self, core):
        ...
        waypoints = [
            Waypoint(latitude=55.7558, longitude=37.6173, altitude=50.0, speed=10.0)  # Near airport no-fly zone
        ]
    ...
    def test_emergency_point_distance_check(self, core, valid_waypoints):
        ...
        far_emergency_points = [Waypoint(lat=56.0, lon=38.0, altitude=0.0, speed=0.0)]  # Very far
