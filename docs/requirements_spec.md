# Техническое задание на разработку первого прототипа (ПП)

## Назначение ПП
Основное назначение прототипа - использование как учебное пособие для знакомства студентов с ключевыми идеями конецпции, отраслевыми и техническими проблемами и способами их решений.
...
* <сервисN>/dockefile - docker файл для сборки образа сервиса N
...
Д6. Должно быть описание процесса отладки для кадого сервиса
...
УВ2. Работа над новыми функциями должна вестись в отдельных ветках, слияние с main веткой основного репозитория должно осуществляться только после создания запроса на слияие (PR) и оценки изменений авторизованными экспертами
...
А3. Каждый сервис должен находиться в отдельной папке
