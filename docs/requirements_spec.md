...
## Назначение ПП
Основное назначение прототипа - использование как учебное пособие для знакомства студентов с ключевыми идеями концепции, отраслевыми и техническими проблемами и способами их решений.
