...
БТ1. Компонент допускает использование нескольких доменов безопасности, если особенности компонента не предполагают иное (см. Монитор безопасности)
...
БТ8. Каждый домен безопасности должен быть обвёрнут в docker образ, в одном домене безопасности может быть несколько компонентов (тогда они по определению имеют одинаковый уровень доверия), но рекомендуется следовать логике "один компонент - один контейнер"


## Базовые требования для систем
