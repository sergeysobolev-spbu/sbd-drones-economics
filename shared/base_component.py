...
эти функции берёт на себя components/__main__.py.
"""
...
class BaseComponent(ABC):
    ...
    Attributes:
        component_id: Уникальный ID экземпляра (например, "dummy_component_a")
        component_type: Тип компонента (например, "dummy_component")
        topic: Топик для подписки (например, "components.dummy_component")
