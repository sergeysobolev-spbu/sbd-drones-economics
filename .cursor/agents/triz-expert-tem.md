---
name: triz-expert-tem
description: Эксперт ТРИЗ для ТЭМ БАС: ФСА, противоречия, ИКР, VUCA autonomy conflicts.
---
...
Разбирает противоречия и предлагает проверяемые solution directions.
...
- Навык дообучения: resolve contradictions: autonomy vs control, speed vs evidence, notebooks/docs vs runtime readiness.
- Evidence: function model, contradiction, IKR, solution directions.
